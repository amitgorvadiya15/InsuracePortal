/* ADDED A 'RETURN' TO LINE 849 TO STOP THE SHARETHIS SCRIPT FROM CRASHING. THIS IS PROBABLY OK AS WE'RE NOT USING VIMEO ON THE SITE */ 
...
Muse.Utils.getCurrentHTMLFileName = function(a) {
    ...
    b.charAt(b.length - 1) == "/" ? b = "index" : (b = b.substring(b.lastIndexOf("../../index.html") + 1), b = b.indexOf("#") == 0 ? "index" : b.substring(0, b.lastIndexOf(".")));
    a && (b += ".html");
    return b
};
...
Muse.Utils.processHyperlink = function(a) {
    var b = a.href,
        ...
        d = a.attr("target");
    if (!d || d == "_self") {
        var g = b.lastIndexOf("../../index.html"),
            d = b.lastIndexOf("#"),
...
Muse.Utils.saveHyperlinkInfo = function(a, b, c, d, g) {
    ...
    if (f && -1 != f.indexOf("#") && !(k && k != "_self") && !(0 <= l.indexOf("../../index.html")) && (i.charAt(i.length - 1) == "/" && (i += "index-2.html"), -1 != i.indexOf("/" + l, i.length - l.length - 1))) {
...
Muse.Utils.needPIE = function(a) {
    ...
    else if (Muse.Utils.pieFunctionQueue.push(a), !Muse.Utils.pieLoading) Muse.Utils.pieLoading = !0, a = "scripts/pie.html", a[0] == "/" && (a = location.pathname.indexOf(".html") != -1 ? location.pathname.substring(0, location.pathname.lastIndexOf("../../index.html")) + a : location.pathname + a, a = a.replace(/\/+/g, "../../index.html")), $.ajax({
        url: a,
        dataType: "script",
        complete: function() {
...
(function(a) {
    ...
    d.prototype.doUpdate = function(a) {
        if (this.enabled)
            if (this.initialized) {
                parseInt(a) || (a = 0);
                this.updateSpacerMargin && this.$spacer.css("margin-bottom", -(this.$spacer.offset().top - this.pageMarginTop));
    ...
    if (!("undefined" == typeof Muse || "undefined" == typeof Muse.assets)) {
        var a = function(a, b) {
            for (var c = 0, d = a.length; c < d; c++)
                if (a[c] == b) return c;
            return -1
        }(Muse.assets.required, "museutils.html");
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.0.2.310" != d.getAttribute("content") && Muse.assets.outOfDate.push("museutils.html");
                    break
                }
            }
        }
